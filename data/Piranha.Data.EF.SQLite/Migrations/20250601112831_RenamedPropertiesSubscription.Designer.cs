...
namespace Piranha.Data.EF.SQLite.Migrations
{
    ...
    [Migration("20250601112831_RenamedPropertiesSubscription")]
    partial class RenamedPropertiesSubscription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Piranha.Models.Key", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(64)
                    ...
                    b.ToTable("Piranha_Keys", (string)null);
                });

            modelBuilder.Entity("Piranha.Models.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("EventType", "EventStatus", "Tags")
                        .IsUnique();

                    b.ToTable("Piranha_Subscriptions", (string)null);
                });
